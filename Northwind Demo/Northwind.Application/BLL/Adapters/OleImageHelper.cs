...
{
    /// <summary>
    /// The OleImageHelper class helps to compensate for the OLE Header
    /// that appears at the start of legacy image data stored in the
    /// Northwinds database.
    /// </summary>
    /// <remarks>
    /// <para>The OleImageHelper class helps to compensate for the OLE Header
    /// that appears at the start of legacy image data stored in the
