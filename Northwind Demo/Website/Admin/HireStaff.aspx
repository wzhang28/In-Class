<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="HireStaff.aspx.cs" Inherits="Admin_HireStaff" %>
    ...
    <div class="row">
        <div class="col-md-6">
            <fieldset>
                ...
                <asp:DropDownList ID="SupervisorList" runat="server" AppendDataBoundItems="true" DataSourceID="SupervisorDataSource" DataTextField="DataText" DataValueField="DataValue">
                    <asp:ListItem Value="">[Select a supervisor]</asp:ListItem>
                </asp:DropDownList>
                <asp:ObjectDataSource runat="server" ID="SupervisorDataSource" OldValuesParameterFormatString="original_{0}" SelectMethod="ListStaffNames" TypeName="Northwind.Application.BLL.HumanResourcesController"></asp:ObjectDataSource>
