...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-footer">
                            ...
                            <asp:Repeater ID="AllTerritories" runat="server"
                                ItemType="Northwind.Data.Entities.Territory" DataSourceID="AllTerritoriesDataSource">
                                <HeaderTemplate>
    ...
    <asp:ObjectDataSource runat="server" ID="AllTerritoriesDataSource" OldValuesParameterFormatString="original_{0}" SelectMethod="ListAllTerritories" TypeName="Northwind.Application.BLL.HumanResourcesController"></asp:ObjectDataSource>
