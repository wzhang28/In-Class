<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FireStaff.aspx.cs" Inherits="Admin_FireStaff" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="row">
        ...
        <asp:Repeater ID="TerritoryReassignmentRepeater" runat="server" ItemType="Northwind.Application.DataModels.StaffTerritory">
            <ItemTemplate>
                <div class="col-md-4">
                    <div class="well">
